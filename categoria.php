...
<main id="main">
  ...
  {
    $categoria = $_GET['/'];
    $stmt_edit = $DB->prepare('SELECT * FROM blog WHERE categoria =:ucategoria');
    $stmt_edit->execute(array(':ucategoria'=>$categoria));
  ...
  <section id="breadcrumbs" class="breadcrumbs">
    <div class="container">
      ...
      <h2>Categoria: <b><?php echo $categoria;?></b></h2>
    </div>
    ...
    <div class="container" data-aos="fade-up">
      <div class="row">
        <div class="col-lg-8 entries">
          <?php
          foreach ($DB->query('SELECT * FROM blog WHERE categoria LIKE "'.$categoria.'"') as $row ){  ?> 
            <article class="entry">
              <div class="entry-img">
