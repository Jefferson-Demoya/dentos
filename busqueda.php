...
<head>
  ...
  <link href="assets/css/modal.css" rel="stylesheet" href="">
</head>
<body>
...
<main id="main">
  ...
  {
    $fecha = $_GET['/'];
    $stmt_edit = $DB->prepare('SELECT * FROM blog WHERE fecha =:ufecha');
    $stmt_edit->execute(array(':ufecha'=>$fecha));
  ...
  <section id="breadcrumbs" class="breadcrumbs">
    <div class="container">
      ...
      <h2>Buscador por fecha: <b><?php echo $fecha;?></b></h2>
    </div>
    ...
    <div class="container" data-aos="fade-up">
      <div class="row">
        <div class="col-lg-8 entries">
          <?php
          foreach ($DB->query('SELECT * FROM blog WHERE fecha LIKE "'.$fecha.'"') as $row ){  ?> 
            <article class="entry">
              <div class="entry-img">
